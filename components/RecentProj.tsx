      ...
      gap-x-24 gap-y-8 mt-10'>
        {
          projects.map(({
            ...
            <div className='lg:min-h-[32.5rem]
          flex items-center justify-center
           w-[80vw] sm:h-[41rem] h-[32rem] sm:w-[570px]
          '
              key={id}>
             <PinContainer title={link} >
              <div className='relative flex items-center justify-center
              sm:w-[570px] w-[80vw] overflow-hidden h-[30vh] mb-10  sm:h-[40vh]'>
              ...
              text-base line-clamp-1'>{title}</h1>
              ...
              <div className='flex justify-center items-center mb-2'>
                <a href={link} className='flex lg:text-xl md:text-xs text-sm text-purple'>view details</a>
              </div>
             </PinContainer>
            </div>
          ))
