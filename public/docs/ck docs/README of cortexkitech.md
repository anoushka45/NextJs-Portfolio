...
![Dashboard — Plan Approved](../../projects/cortexkitchen/03_dashboard/03_plan_approved_top.png)
...
![Dashboard — Pipeline Running](../../projects/cortexkitchen/03_dashboard/02_loading_screen.png)
...
![Dashboard — Full Plan](../../projects/cortexkitchen/03_dashboard/04_full_plan_scroll.png)
...
![Service Planning & Reservation Pressure](../../projects/cortexkitchen/03_dashboard/05_service_planning.png)
...
![Menu Direction](../../projects/cortexkitchen/03_dashboard/06_menu_direction.png)
...
![Operational Risk](../../projects/cortexkitchen/03_dashboard/07_operational_risk.png)
...
![PDF Chef Brief](../../projects/cortexkitchen/08_exports/pdf_chef_brief.png)
...
![Excel — Inventory & Staffing](../../projects/cortexkitchen/08_exports/excel_inventory_chef_view.png)
...
![Excel — Cost Breakdown](../../projects/cortexkitchen/08_exports/excel_cost_breakdown_owner_view.png)
...
![Ask AI — Empty State](../../projects/cortexkitchen/05_chat/01_empty_state.png)
...
![Ask AI — Conversation](../../projects/cortexkitchen/05_chat/02_conversation_complaints.png)
...
![Ask AI — Performance Overview](../../projects/cortexkitchen/05_chat/03_conversation_performance.png)
...
![What-If Simulator](../../projects/cortexkitchen/03_dashboard/08_what_if_simulator.png)
...
![Run History](../../projects/cortexkitchen/04_runs/runs_history_page.png)
...
![Run Detail](../../projects/cortexkitchen/04_runs/run_detail_panel.png)
...
![Data Health](../../projects/cortexkitchen/06_data_health/data_health.png)
...
![Observability Panel](../../projects/cortexkitchen/06_data_health/observability_panel.png)
...
![LangSmith Golden Dataset](../../projects/cortexkitchen/09_observability_tools/langsmith_golden_dataset.png)
...
![LangSmith Run Traces](../../projects/cortexkitchen/09_observability_tools/langsmith_run_traces.png)
*LangSmith run traces — per-run tracing with latency breakdown per node, scenario labels, and linked evaluation datasets.*

![Sentry Error Capture](../../projects/cortexkitchen/09_observability_tools/sentry_error_capture.png)
...
![Settings](../../projects/cortexkitchen/07_config/settings.png)
...
![Restaurant Profiles](../../projects/cortexkitchen/07_config/restaurant_profiles.png)
...
![Homepage Hero](../../projects/cortexkitchen/01_homepage/hero.png)
...
![Homepage Pipeline](../../projects/cortexkitchen/01_homepage/pipeline.png)
...
![Login](../../projects/cortexkitchen/02_auth/login.png)
*Login page — email and password sign-in with a link to create a new workspace.*

![Register](../../projects/cortexkitchen/02_auth/register.png)
...
../../projects/cortexkitchen/                    # Feature screenshots organized by section
